...
const translations = {
  en: {
    ...
    'home.hero.slide.research.subtitle': 'Climate events and human health in urban contexts',
    'home.hero.slide.training.title': 'Training Programs',
    'home.hero.slide.training.subtitle': 'Promoting adherence and behavioral change in the treatment of obesity and associated diseases',
    'home.hero.slide.clinical.title': 'Clinical Services',
    'home.hero.slide.clinical.subtitle': 'Evidence-based psychological interventions and specialized treatments',
    'home.hero.slide.digital.title': 'Digital Development',
    'home.hero.slide.digital.subtitle': 'Software development for research support',
    'home.hero.slide.editorial.title': 'Editorial Services',
  ...
  pt: {
    ...
    'home.hero.slide.research.subtitle': 'Eventos climáticos e saúde humana em contextos urbanos',
    'home.hero.slide.training.title': 'Programas de Formação',
    'home.hero.slide.training.subtitle': 'Promoção da adesão e da mudança comportamental no tratamento da obesidade e doenças associadas',
    'home.hero.slide.clinical.title': 'Serviços Clínicos',
    'home.hero.slide.clinical.subtitle': 'Intervenções psicológicas baseadas em evidência e tratamentos especializados',
    'home.hero.slide.digital.title': 'Desenvolvimento de Software',
    'home.hero.slide.digital.subtitle': 'Desenvolvimento de software para apoio à investigação',
    'home.hero.slide.editorial.title': 'Serviços Editoriais',

...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.hero.slide.research.title': 'Research Activities',
    'home.hero.slide.research.subtitle': 'Quantitative, qualitative and mixed research to support decision-making',
    'home.hero.slide.training.title': 'Training Programs',
    'home.hero.slide.training.subtitle': 'Advanced clinical training and training on clinical and translational research methods',
    'home.hero.slide.clinical.title': 'Clinical Services',
    'home.hero.slide.clinical.subtitle': 'Evidence-based psychological intervention and psychotherapy',
    'home.hero.slide.digital.title': 'Digital Solutions',
    'home.hero.slide.digital.subtitle': 'Development of websites, apps and monitoring systems',
    'home.hero.slide.editorial.title': 'Acendalha Publishing',
    'home.hero.slide.editorial.subtitle': 'Scientific and literary publishing through Acendalha Publishing',
    ...
    'home.innovation.desc1': 'Under the leadership of CEO Osvaldo Santos, a clinical and health psychologist and researcher, UBKIR combines cutting-edge research methodologies with practical applications in healthcare, education, and digital innovation.',
    ...
    'team.david.bio2': 'At UBKIR, he contributes to the development and continued evolution of digital platforms and solutions.',
    ...
    'contacts.form.turnstile.error': 'Anti-bot verification failed. Please try again, or contact us directly at info@ubkir.pt',
    'contacts.form.turnstile.pending': 'Verifying your browser, please wait a moment and try again.',
  ...
  pt: {
    ...
    'home.hero.slide.research.title': 'Atividades de Investigação',
    'home.hero.slide.research.subtitle': 'Investigação quantitativa, qualitativa e mista para apoio à decisão',
    'home.hero.slide.training.title': 'Programas de Formação',
    'home.hero.slide.training.subtitle': 'Formação clínica avançada e formação sobre métodos de investigação clínica e translacional',
    'home.hero.slide.clinical.title': 'Serviços Clínicos',
    'home.hero.slide.clinical.subtitle': 'Intervenção psicológica e psicoterapia baseada em evidência',
    'home.hero.slide.digital.title': 'Soluções digitais',
    'home.hero.slide.digital.subtitle': 'Desenvolvimento de sites, apps e sistemas de monitorização',
    'home.hero.slide.editorial.title': 'Editora Acendalha',
    'home.hero.slide.editorial.subtitle': 'Publicação científica e literária através da Acendalha Publishing',
    ...
    'home.innovation.desc1': 'Sob a liderança do CEO Osvaldo Santos, psicólogo clínico e da saúde, e investigador, a UBKIR combina metodologias de investigação de vanguarda com aplicações práticas em cuidados de saúde, educação e inovação digital.',
    ...
    'team.david.bio2': 'Na UBKIR, contribui para o desenvolvimento e evolução de plataformas e soluções digitais.',
    ...
    'contacts.form.turnstile.error': 'A verificação anti-robô falhou. Tente novamente ou contacte-nos diretamente em info@ubkir.pt',
    'contacts.form.turnstile.pending': 'A verificar o seu navegador. Aguarde um momento e tente novamente.',

...
const translations = {
  ...
  pt: {
    ...
    'home.innovation.desc1': 'Sob a liderança do CEO Osvaldo Santos, um renomado psicólogo clínico e da saúde e investigador, a UBKIR combina metodologias de investigação de vanguarda com aplicações práticas em cuidados de saúde, educação e inovação digital.',
